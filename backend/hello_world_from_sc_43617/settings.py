"""
Django settings for hello_world_from_sc_43617 project.
...
ROOT_URLCONF = 'hello_world_from_sc_43617.urls'
...
WSGI_APPLICATION = 'hello_world_from_sc_43617.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hello_world_from_sc_43617 API",
    "DESCRIPTION": "API documentation for hello_world_from_sc_43617 App",
    "VERSION": "v1",
}
