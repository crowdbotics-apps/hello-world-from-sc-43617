...
## Project Structure
    ...
    ├── hello_world_from_sc_43617  # Django project configurations
...
1. Clone this repo and `cd hello_world_from_sc_43617`
...
2. Clone this repo and `cd hello_world_from_sc_43617`
